...
$id_client_atual = $_POST['client_name'];
$SELECT = "SELECT * FROM register WHERE id= '$id_client_atual'";
    ...
    <div class="row">
      ...
      <div class ="col-4">
        ...
        <div class="container" style="width:100%;"> <br>
          ...
          <br>
          <div class="format"> 
            <label for=""><h4>Cliente ID:<?php echo "  ".$row['id'];?>.</h4> </label> 
          </div>
          <br>
          <div>
            <label for=""><h4>Nome do Cliente: <?php echo "  ".$row['name'];?>.</h4> </label>
          </div>
          <br>
          <div>
            <label for=""><h4>Rua da Residência: <?php echo "  ".$row['street'];?>.</h4> </label>
          </div>
          <br>
          <div>
            <label for=""><h4>Cidade: <?php echo "  ".$row['city'];?>.</h4> </label>
          </div>
