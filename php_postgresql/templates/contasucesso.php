...
if(isset($_POST['account_id']) && isset($_POST['account_city']) && isset($_POST['account_balance']) && ($_POST['account_balance'] >=0)){

    $account_id = $_POST['account_id'];      
    $account_city = $_POST['account_city']; 
    $account_balance = $_POST['account_balance'];
    $account_agency = $_POST['account_agency'];
    
    $_SESSION['atual_account_id'] = $account_id;

    
    //string para inserir registro na tabela usando insert into e os valores capturados por POST do formulario
    $INSERT = "INSERT INTO account (id, city, saldo, agency) VALUES ('$account_id','$account_city','$account_balance', '$account_agency')" ;
